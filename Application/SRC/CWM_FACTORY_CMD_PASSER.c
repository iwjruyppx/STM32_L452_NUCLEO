...
const CWM_FACTORY_t FACTORY_TABLE[] =
{
    ...
    SIGN_FUN_INTO_FACTCMD_T("$selftest Mag: on", FACTORY_TYPE_FACTORY_MODE, FACTORY_CMD_SELFTEST, FACTORY_OPC_GYROSCOPE, SelftTestGyro_Cb)
    SIGN_FUN_INTO_FACTCMD_T("$selftest Gyro: on", FACTORY_TYPE_FACTORY_MODE, FACTORY_CMD_SELFTEST, FACTORY_OPC_MAGNETOMETER, SelftTestMag_Cb)
};
